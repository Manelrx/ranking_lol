...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-emerald-500/30 overflow-x-hidden w-full font-sans relative pb-32">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 md:px-8 pt-8">
